  ...
  void _submitForm() async {
    if (_isFormValid()) {
      ...
      final formData = {
        ...
        "startersOption1": int.tryParse(_startersOption1Controller.text) ?? -1,
        "startersOption2": int.tryParse(_startersOption2Controller.text) ?? -1,
        "mainOption1": int.tryParse(_mainOption1Controller.text) ?? -1,
        "mainOption2": int.tryParse(_mainOption2Controller.text) ?? -1,
        "mainOption3": int.tryParse(_mainOption3Controller.text) ?? -1,
        "dessertOption1": int.tryParse(_dessertOption1Controller.text) ?? -1,
        "dessertOption2": int.tryParse(_dessertOption2Controller.text) ?? -1,
