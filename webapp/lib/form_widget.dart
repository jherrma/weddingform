  ...
  void _submitForm() async {
    if (_isFormValid()) {
      ...
      final formData = {
        ...
        "startersOption1": int.tryParse(_startersOption1Controller.text) ?? 0,
        "startersOption2": int.tryParse(_startersOption2Controller.text) ?? 0,
        "mainOption1": int.tryParse(_mainOption1Controller.text) ?? 0,
        "mainOption2": int.tryParse(_mainOption2Controller.text) ?? 0,
        "mainOption3": int.tryParse(_mainOption3Controller.text) ?? 0,
        "dessertOption1": int.tryParse(_dessertOption1Controller.text) ?? 0,
        "dessertOption2": int.tryParse(_dessertOption2Controller.text) ?? 0,
